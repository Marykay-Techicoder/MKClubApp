     ...
     <div class="container" data-aos="fade-up" data-aos-delay="100">
       <div class="row gy-4">
         ...
         <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center">
           ...
           <div class="stats-item">
             <span data-purecounter-start="0" data-purecounter-end="1022" data-purecounter-duration="1"
               class="purecounter"></span>
       ...
       <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
         <div class="tab-pane fade active show" id="tabs-tab-1">
           <div class="row">
             <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
               ...
               <ul>
                 <li>
                   ...
                   <spab>Ullamco laboris nisi ut aliquip
                     ex ea commodo consequat.</spab>
                 </li>
                 <li>
                   <i class="bi bi-check2-all"></i>
             ...
             <div class="col-lg-6 order-1 order-lg-2 text-center">
               <img src="{{asset('Presento/assets/img/working-1.jpg')}}" alt="" class="img-fluid" />
               '
             </div>
           </div>
         </div>
         ...
         <div class="tab-pane fade" id="tabs-tab-2">
           <div class="row">
             <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
               <h3>
                 Neque exercitationem debitis soluta quos
                 debitis quo mollitia officia est
               </h3>
               <p>
                 Ullamco laboris nisi ut aliquip ex ea
                 commodo consequat. Duis aute irure dolor
             ...
             <div class="col-lg-6 order-1 order-lg-2 text-center">
               <img src="{{asset('Presento/assets/img/working-2.jpg')}}" alt="" class="img-fluid" />
               '
             </div>
           </div>
         </div>
           ...
           <div class="row">
             <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
               <h3>
                 ...
                 repudiandae ut autem dolor ut assumenda
               </h3>
               <p>
                 Ullamco laboris nisi ut aliquip ex ea
                 commodo consequat. Duis aute irure dolor
             ...
             <div class="col-lg-6 order-1 order-lg-2 text-center">
               <img src="{{asset('Presento/assets/img/working-3.jpg')}}" alt="" class="img-fluid" />
               '
             </div>
           </div>
         </div>
         ...
         <div class="tab-pane fade" id="tabs-tab-4">
           <div class="row">
             <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
               <h3>
                 Omnis fugiat ea explicabo sunt dolorum
                 asperiores sequi inventore rerum
               </h3>
               <p>
                 Ullamco laboris nisi ut aliquip ex ea
                 commodo consequat. Duis aute irure dolor
             ...
             <div class="col-lg-6 order-1 order-lg-2 text-center">
               <img src="{{asset('Presento/assets/img/working-4.jpg')}}" alt="" class="img-fluid" />
