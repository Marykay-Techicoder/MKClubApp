  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto">
        ...
        <!-- <img src=" {{asset ('Presento/assets/img/logo.png')}}" alt=""> -->
              ...
              <div class="row gy-4">
                ...
                <div class="col-12">
                  <article>
                    ...
                    <div class="post-img">
                      <img src="{{asset('Presento/assets/img/blog/blog-1.jpg')}}" alt="" class="img-fluid">
                    </div>
                ...
                <div class="col-12">
                  ...
                  <article>
                    ...
                    <div class="post-img">
                      <img src=" {{asset ('Presento/assets/img/blog/blog-2.jpg') }}" alt="" class="img-fluid">
                    </div>
                ...
                <div class="col-12">
                  ...
                  <article>
                    ...
                    <div class="post-img">
                      <img src=" {{asset ('Presento/assets/img/blog/blog-3.jpg')}}" alt="" class="img-fluid">
                    </div>
                ...
                <div class="col-12">
                  ...
                  <article>
                    ...
                    <div class="post-img">
                      <img src=" {{asset ('Presento/assets/img/blog/blog-4.jpg')}}" alt="" class="img-fluid">
                    </div>
        ...
        <div class="col-lg-4 sidebar">
          ...
          <div class="widgets-container">
            ...
            <div class="recent-posts-widget widget-item">
              ...
              <div class="post-item">
                <img src=" {{asset ('Presento/assets/img/blog/blog-recent-1.jpg')}}" alt="" class="flex-shrink-0">
                <div>
              ...
              <div class="post-item">
                <img src=" {{asset ('Presento/assets/img/blog/blog-recent-2.jpg')}}" alt="" class="flex-shrink-0">
                <div>
              ...
              <div class="post-item">
                <img src=" {{asset ('Presento/assets/img/blog/blog-recent-3.jpg')}}" alt="" class="flex-shrink-0">
                <div>
              ...
              <div class="post-item">
                <img src=" {{asset ('Presento/assets/img/blog/blog-recent-4.jpg')}}" alt="" class="flex-shrink-0">
                <div>
              ...
              <div class="post-item">
                <img src=" {{asset ('Presento/assets/img/blog/blog-recent-5.jpg')}}" alt="" class="flex-shrink-0">
                <div>
